...
Genomic Hybridization. It implements our methodology for finding change-points in these data (Olshen
...
of gained and lost copy number. 
...
strains. In particular, we chose the studies GM05296. After selecting
